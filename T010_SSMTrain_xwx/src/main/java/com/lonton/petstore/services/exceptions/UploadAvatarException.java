package com.lonton.petstore.services.exceptions;
...
public class UploadAvatarException extends ServiceException {
    ...
    protected UploadAvatarException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
