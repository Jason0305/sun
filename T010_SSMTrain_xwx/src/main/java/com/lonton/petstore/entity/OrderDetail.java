...
public class OrderDetail {
    ...
    public OrderDetail(Integer id, Integer orderId, Long petId, String petName, Integer petAge, String petColor, BigDecimal petPrice, String petImage, Integer petNum) {
        this.id = id;
